...
class GradientPeaks:
    ...
    def expandPeak(self, peak, x, y):
        ...
        while goOn and (peak.peakIndex - peak.peakLeftFlank - 1) > 0:
            ...
            if rat > self.minIncreaseRatio and rat < 1.0 and y[peak.peakIndex - peak.peakLeftFlank - 1] >= self.minIntFlanks:
        ...
        while goOn and (peak.peakIndex + peak.peakRightFlank + 1) < len(x):
            ...
            if rat > self.minIncreaseRatio and rat < 1.0 and y[peak.peakIndex + peak.peakRightFlank + 1] >= self.minIntFlanks:
    ...
    def calcPeakProperties(self, x, y, peak):
        ...
        peak.baseLineRatio = (y[peak.peakIndex] - (y[peak.peakIndex - peak.peakLeftFlank] + y[peak.peakIndex + peak.peakRightFlank]) / 2.0) / y[peak.peakIndex]
...
if __name__ == "__main__":
    ...
    cp = MassSpecWavelet(get_main_dir() + "/src/chromPeakPicking/MassSpecWaveletIdentification.R")
    print("------------")
