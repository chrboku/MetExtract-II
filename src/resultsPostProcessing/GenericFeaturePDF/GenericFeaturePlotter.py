        ...
        for file in expGroup.files:
            ...
            try:
                ...
                if normEICs:
                    mval = max(
                        maxEICValue,
                        max([eic[j] for j in range(len(eic)) if (feature.rt - feature.rtBorders) <= (times[j] / 60.0) <= (feature.rt + feature.rtBorders)]),
                    )
                ...
                eicsDD.append([(times[j] / 60.0, eic[j]) for j in range(len(eic)) if (feature.rt - feature.rtBorders) <= (times[j] / 60.0) <= (feature.rt + feature.rtBorders)])

                ## plot separated EICs to drawing
                eicsSeparatedDD.append(
                    [
                        (
                            (times[j] + showGroupRTShift * (i + 3) * 60) / 60.0 - feature.rt,
                            eic[j],
                        )
                        for j in range(len(eic))
                        if (feature.rt - feature.rtBorders) <= (times[j] / 60.0) <= (feature.rt + feature.rtBorders)
                    ]
                )
            ...
            try:
                ...
                ## plot overlaied EICs to drawing
                eicsLDD.append([(times[j] / 60.0, eic[j]) for j in range(len(eic)) if (feature.rt - feature.rtBorders) <= (times[j] / 60.0) <= (feature.rt + feature.rtBorders)])
            ...
            try:
                ...
                bestScanIndex = max(
                    [(j, ab) for j, ab in enumerate(eic) if (feature.rt - feature.rtBorders / 3) <= (times[j] / 60.0) <= (feature.rt + feature.rtBorders / 3)],
                    key=lambda x: x[1],
                )[0]
                ...
                for uInd in uInds:
                    ...
                    if abs(mz - feature.mz) * 1e6 / feature.mz <= 5.0 or abs(mz - feature.lmz) * 1e6 / feature.lmz <= 5.0:
                        scanDD.append([(mz, 0), (mz, ab)])
                        scanCols.append(matplotlib.colors.cnames[expGroup.color.lower()])
                        scanWidths.append(1.0)
                    elif abs(mz - feature.mz - 1.00335484) * 1e6 / feature.mz <= 5.0 or abs(mz + 1.00335484 - feature.lmz) * 1e6 / feature.lmz <= 5.0:
                        scanDD.append([(mz, 0), (mz, ab)])
                        scanCols.append(matplotlib.colors.cnames[expGroup.color.lower()])
            ...
            for j, scan in enumerate(scans):
                ...
                for k in range(len(scan)):
                    ...
                    AreaLDD.append([(rt / 60.0, (mz - feature.lmz) * 1e6 / feature.lmz)])
...
def generatePDF(
    ...
    for metabolite in metabolitesToPlot:
        for feature in metabolite.features:
            importFilter.append((feature.mz * (1.0 - ppm * 5 / 1e6), feature.mz * (1.0 + ppm * 5 / 1e6)))
            importFilter.append(
                (
    ...
    for metabolite in metabolitesToPlot:
        print(
            ("\rProcessing.. |%%-%ds| (%%d/%%d)" % (len(metabolitesToPlot))) % ("*" * done, done, len(metabolitesToPlot)),
        )
        if not done % 100:
            if pdf is not None:
                pdf.save()
        ...
        if drawMetaboliteIntroPage:
            pdf.drawString(
                20,
                820,
                "Name: %s OGroup: %s Number of features: %d" % (metabolite.name, metabolite.ogroup, len(metabolite.features)),
            )
            pdf.showPage()
...
if __name__ == "__main__" and True:
    ...
    if False:
        ...
        experimentalGroups.append(
            Bunch(
                name="NHC dmalQ",
                files=[
                    path + "/NHC_dmalQ/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_26_1AH_Cells_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NHC dmalQDmaa",
                files=[
                    path + "/NHC_dmalQDmaa/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_30_2AH_Cells_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NHC dmnaT",
                files=[
                    path + "/NHC_dmnaT/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_10_B1H_Cells_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NHC wildtype",
                files=[
                    path + "/NHC_wildtype/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_7_A1H_Cells_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NNC dmalQ",
                files=[
                    path + "/NNC_dmalQ/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_25_1A_Cells_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NNC dmalQDmaa",
                files=[
                    path + "/NNC_dmalQDmaa/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_29_2A_Cells_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NNC dmnaT",
                files=[
                    path + "/NNC_dmnaT/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_4_B1_Cells_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NNC wildtype",
                files=[
                    path + "/NNC_wildtype/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_1_A1_Cells_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NHM dmalQ",
                files=[
                    path + "/NHM_dmalQ/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_34_1AH_Media_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NHM dmalQDmaa",
                files=[
                    path + "/NHM_dmalQDmaa/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_38_2AH_Media_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NHM dmnaT",
                files=[
                    path + "/NHM_dmnaT/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_22_B1H_Media_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NHM wildtype",
                files=[
                    path + "/NHM_wildtype/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_19_A1H_Media_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NNM dmalQ",
                files=[
                    path + "/NNM_dmalQ/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_33_1A_Media_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NNM dmalQDmaa",
                files=[
                    path + "/NNM_dmalQDmaa/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_37_2A_Media_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NNM dmnaT",
                files=[
                    path + "/NNM_dmnaT/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_16_B1_Media_n.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="NNM wildtype",
                files=[
                    path + "/NNM_wildtype/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_13_A1_Media_n.mzXML",
    ...
    if False:
        ...
        experimentalGroups.append(
            Bunch(
                name="PNC dmalQ",
                files=[
                    path + "/PNC_dmalQ/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_25_1A_Cells_p.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="PNC dmnaT",
                files=[
                    path + "/PNC_dmnaT/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_4_B1_Cells_p.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="PNM dmalQ",
                files=[
                    path + "/PNM_dmalQ/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_33_1A_Media_p.mzXML",
        ...
        experimentalGroups.append(
            Bunch(
                name="PNM dmnaT",
                files=[
                    path + "/PNM_dmnaT/QE2_jdg_62_Hanson_Niehaus_Hanson_Niehaus_16_B1_Media_p.mzXML",
    ...
    if True:
        ...
        experimentalGroups.append(
            Bunch(
                name="422",
                files=["E:/180420_422_MSMS_for_Papers/RawData/EVAL_BiologicalPublication_GMLPHE/MatchMSMSDataToDataMatrix/BiologicalPaper/exampleFiles/422_GML_Remus_DON_MSMS_Rep1_pos.mzXML"],
                color="Firebrick",
            )
        )
        ...
        experimentalGroups.append(
            Bunch(
                ...
                files=["E:/180420_422_MSMS_for_Papers/RawData/EVAL_BiologicalPublication_GMLPHE/MatchMSMSDataToDataMatrix/BiologicalPaper/exampleFiles/Remus_DON_0h_pooled_12C13C.mzXML"],
                color="Olivedrab",
            )
        )
