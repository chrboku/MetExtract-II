...
data_files.append("./src/chromPeakPicking/MassSpecWaveletIdentification.r")
data_files.append("./src/XICAlignment.r")
...
try:
    ...
    copy(
        "./src/chromPeakPicking/MassSpecWaveletIdentification.r",
        "./dist/src/chromPeakPicking/MassSpecWaveletIdentification.r",
    )
    copy("./src/XICAlignment.r", "./dist/src/XICAlignment.r")
