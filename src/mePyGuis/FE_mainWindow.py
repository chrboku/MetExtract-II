...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.processFilesTable = QtWidgets.QTableView(self.inputTab)
        self.processFilesTable.setAlternatingRowColors(False)
        self.processFilesTable.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.processFilesTable.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
