...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.combineResultsButton.setStyleSheet(_fromUtf8("background-image: url(:/combineResults/resources/combineResults.png);"))
        ...
        self.fticrExtractIcon.setStyleSheet(_fromUtf8("background-image: url(:/FTICRExtract/resources/FTICRExtract.png);"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Combine results\n(AllExtract and TracExtract)\n", None))
        self.fragExtractLabel.setText(_translate("MainWindow", "FragExtract\n(LC-HRMS)\n", None))
        self.documentationLabel.setText(_translate("MainWindow", "Documentation", None))
        self.allExtractLabel.setText(_translate("MainWindow", "AllExtract\n(LC-HRMS)", None))
        self.tracExtractLabel.setText(_translate("MainWindow", "TracExtract\n(LC-HRMS)", None))
        self.label_3.setText(_translate("MainWindow", "FTICRExtract\n(FT-ICR-MS)\n", None))
