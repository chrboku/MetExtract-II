...
"font: 7pt;"))
        ...
        spacerItem5 = QtGui.QSpacerItem(200, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        GroupEditor.setTabOrder(self.groupName, self.addFiles)
        GroupEditor.setTabOrder(self.addFiles, self.groupMinimumFound)
        GroupEditor.setTabOrder(self.groupMinimumFound, self.omitFeatures)
        GroupEditor.setTabOrder(self.omitFeatures, self.useForMetaboliteGrouping)
        GroupEditor.setTabOrder(self.useForMetaboliteGrouping, self.removeAsFalsePositive)
        GroupEditor.setTabOrder(self.removeAsFalsePositive, self.colorsComboBox)
        GroupEditor.setTabOrder(self.colorsComboBox, self.dialogFinished)
        GroupEditor.setTabOrder(self.dialogFinished, self.dialogCanceled)
        GroupEditor.setTabOrder(self.dialogCanceled, self.addFolder)
        GroupEditor.setTabOrder(self.addFolder, self.removeSelected)
        GroupEditor.setTabOrder(self.removeSelected, self.groupFiles)
