...
"font: 7pt;"))
        ...
        self.omitFeatures = QtGui.QGroupBox(GroupEditor)
        self.omitFeatures.setCheckable(True)
        self.omitFeatures.setObjectName(_fromUtf8("omitFeatures"))
        self.gridLayout_4 = QtGui.QGridLayout(self.omitFeatures)
        self.gridLayout_4.setObjectName(_fromUtf8("gridLayout_4"))
        self.label_4 = QtGui.QLabel(self.omitFeatures)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.gridLayout_4.addWidget(self.label_4, 0, 0, 1, 1)
        self.groupMinimumFound = QtGui.QSpinBox(self.omitFeatures)
