...
"font: 7pt;"))
        ...
        GroupEditor.setTabOrder(self.removeSelected, self.groupMinimumFound)
        ...
        GroupEditor.setTabOrder(self.useAsMSMSTarget, self.colorsComboBox)
        GroupEditor.setTabOrder(self.colorsComboBox, self.dialogCanceled)
