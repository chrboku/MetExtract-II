...
"font: 7pt;"))
        ...
        self.tAmountA = QtGui.QDoubleSpinBox(Dialog)
        self.tAmountA.setProperty("value", 50.0)
        self.tAmountA.setObjectName(_fromUtf8("tAmountA"))
        self.formLayout.setWidget(6, QtGui.QFormLayout.FieldRole, self.tAmountA)
        self.tAmountB = QtGui.QDoubleSpinBox(Dialog)
        self.tAmountB.setProperty("value", 50.0)
        self.tAmountB.setObjectName(_fromUtf8("tAmountB"))
        self.formLayout.setWidget(7, QtGui.QFormLayout.FieldRole, self.tAmountB)
        ...
        self.formLayout.setWidget(9, QtGui.QFormLayout.FieldRole, self.tMinRatio)
        ...
        self.formLayout.setWidget(10, QtGui.QFormLayout.FieldRole, self.tMaxRatio)
        self.label_13 = QtGui.QLabel(Dialog)
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.formLayout.setWidget(8, QtGui.QFormLayout.LabelRole, self.label_13)
        self.tTheoreticalSignalRatio = QtGui.QLabel(Dialog)
        self.tTheoreticalSignalRatio.setObjectName(_fromUtf8("tTheoreticalSignalRatio"))
        self.formLayout.setWidget(8, QtGui.QFormLayout.FieldRole, self.tTheoreticalSignalRatio)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_11.setText(_translate("Dialog", "Minimum ratio (%)", None))
