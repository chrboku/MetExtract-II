...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.descriptionText = QtWidgets.QLabel(Dialog)
        ...
        self.descriptionText.setAlignment(
        ...
        self.loadTable = QtWidgets.QPushButton(Dialog)
        ...
        self.c1 = QtWidgets.QComboBox(self.scrollAreaWidgetContents)
