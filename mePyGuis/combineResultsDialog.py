...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.expELoad = QtWidgets.QPushButton(self.groupBox)
        self.expELoad.setObjectName(_fromUtf8("expELoad"))
        self.gridLayout_2.addWidget(self.expELoad, 16, 3, 1, 1)
        self.expFLoad = QtWidgets.QPushButton(self.groupBox)
        ...
        self.expFSave = QtWidgets.QLineEdit(self.groupBox)
        self.expFSave.setObjectName(_fromUtf8("expFSave"))
        self.gridLayout_2.addWidget(self.expFSave, 20, 2, 1, 1)
        self.expFPrefix = QtWidgets.QLineEdit(self.groupBox)
        ...
        self.expAPrefix = QtWidgets.QLineEdit(self.groupBox)
        ...
        self.expALoad = QtWidgets.QPushButton(self.groupBox)
        ...
        self.expCLoad = QtWidgets.QPushButton(self.groupBox)
        ...
        self.expBSave = QtWidgets.QLineEdit(self.groupBox)
        ...
        self.expBLoad = QtWidgets.QPushButton(self.groupBox)
        ...
        self.maxPPMDev = QtWidgets.QDoubleSpinBox(self.groupBox_2)
        ...
        self.maxRTDev = QtWidgets.QDoubleSpinBox(self.groupBox_2)
